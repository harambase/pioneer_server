  ...
  <div class="auth-block">
    ...
    <form class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputName3" placeholder="*全名" minlength="1" maxlength="20" required>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="qq" placeholder="*QQ号" minlength="6" maxlength="16" required>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="tel" placeholder="*电话号码" minlength="8" maxlength="11" required>
        </div>
      </div>
      <div class="form-group">
