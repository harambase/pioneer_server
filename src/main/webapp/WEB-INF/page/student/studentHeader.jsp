    ...
    <ul>
        ...
        <li><a href="#"><i class="fa fa-user push"></i>Service<i class="fa fa-angle-right"></i></a>
            ...
            <ul class="sub-menu">
                ...
                <li><a href="#">Course Registration<i class="fa fa-angle-right"></i></a><span class="hover"></span></li>
                <li><a href="#">Course Lookup<i class="fa fa-angle-right"></i></a><span class="hover"></span></li>
                <li><a href="#">Transcript View<i class="fa fa-angle-right"></i></a><span class="hover"></span></li>
            </ul>
        </li>
