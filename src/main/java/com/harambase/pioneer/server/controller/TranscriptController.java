...
public class TranscriptController {
    ...
    public ResponseEntity list(@RequestParam(value = "start") Integer start,
        ...
        ResultMap resultMap = transcriptService.transcriptList(String.valueOf(start / length + 1), String.valueOf(length), search, order, orderCol, studentId, crn, info, complete);
        return new ResponseEntity<>(resultMap, HttpStatus.OK);
    }
