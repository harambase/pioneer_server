...
////                StudentView stu = SRSFunctions.makeAStudent(id);
////
////                info[0] = "StudentView ID,StudentView Name,StudentView Earned Credits";
...
////        List<StudentView> couStuList = SRSFunctions.makeStudentsList(crn);
...
////
////        info[5] = "StudentView ID, StudentView Name, StudentView Grade, StudentView Completion, Notification";
////
////        while(couStuList.listIterator(index).hasNext()){
////            StudentView stu = couStuList.get(index);
...
////        info[i] = "General Grading about this CourseBase:," + "Passed StudentView Amount = " + pass + ", Failed StudentView Amount = "
////                + notPass + ", Dropped StudentView = " + drop + ", Pass Rate = " + passRate + ", Failed Rate = " + failRate;
////        PrintWriter pw;
////        i++;
////        try {
...
////            String[] info = new String[500];
////            StudentView stu = SRSFunctions.makeAStudent(id);
////            info[0] = "StudentView ID,StudentView Name,StudentView Earned Credits, Studeent faculty Advisor";
////            info[1] = id + "," + stu.getName() + "," + stu.getCredits() + "," + stu.getFa().getName();
////            info[2] = "More basic Info:,StudentView tele, StudentView qq, StudentView dorm";
////            info[3] = " ," + stu.getTele() + "," + stu.getQq() + "," + stu.getDorm();
////            info[4] = "StudentView Registering status: ,isActive Adding courses(AA/AD), isActive fully Dropping courses(AD/DD), is Active";
...
////                                + "," + tran.getGrade()
////                                + "," + tran.getComplete() + ",The StudentView has dropped this course. Not included in passing "
////                                + "rate calculation";
////                        drop++;
////                    }
////                    else if (tran.getGrade().equals("F")){
////                        info[i] = "," + crn + "," + stuCouList.get(index).getName()+","+stuCouList.get(index).getCredits()
////                                + "," + tran.getGrade()
////                                + "," + tran.getComplete() + ",The StudentView has failed this course.";
////                        notPass++;
////                        total++;
...
////                                + failRate + "%.";
////                        i++;
////                        info[i] = "StudentView Registered Credits = " + credits + "StudentView Earned Credits = " + stu.getCredits();
////                        i++;
////                        total = 0;
////                        pass = 0;
////                        notPass = 0;
...
////                }
////            }
////            info[i] = "StudentView Total Earned Credits = " + stu.getCredits();
////            i++;
////            PrintWriter pw = new PrintWriter(fl);
////            while(j<i){
////                pw.println(info[j]);
...
////            fl.createNewFile();
////            Professor pro = SRSFunctions.makeAProfessor(id);
////            List<StudentView> stuAdvList = SRSFunctions.makeAdvisingList(id);
...
////            info[3] = "Basic Infomation:,StudentView ID,StudentView Name,StudentView Earned Credits" +
////                    ", More detail Info:,StudentView tele, StudentView qq, StudentView dorm" +
////                    ", StudentView Registering status: ,isActive Adding courses(AA/AD), isActive fully Dropping courses(AD/DD), is Active";
////
////            while(stuAdvList.listIterator(index).hasNext()){
////                StudentView stu = stuAdvList.get(index);
...
////                i++;
////            }
////            info[i + 1] = "Total Advising StudentView Amount: " + total + " .";
////            PrintWriter pw = new PrintWriter(fl);
////            while(j < i){
////                pw.println(info[j]);
////                j++;
...
////            String[] info = new String[1000];
////            int i = 1, j = 0, total = 0;
////            info[0] = "Format:,StudentView's ID, StudentView's password, Students's name, StudentView's Activation Status, StudentView's Earned Credits";
////            while(sc.hasNext()){
////                String line = sc.nextLine();
////                String[] split = new String[5];
////                split = line.split("\t");
