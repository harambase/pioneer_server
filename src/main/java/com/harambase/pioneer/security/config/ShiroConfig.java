...
public class ShiroConfig {
     ...
     */
    @Bean
    public DefaultWebSecurityManager securityManager(CookieRememberMeManager rememberMeManager, DefaultWebSessionManager defaultWebSessionManager) {
     ...
     */
    @Bean
    public DefaultWebSessionManager defaultWebSessionManager(PioneerProperties pioneerProperties) {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
         ...
         * 没有权限跳转的url
         */
        shiroFilter.setUnauthorizedUrl("/auth");
        /**
         * 配置shiro拦截器链
         *
         * anon  不需要认证
