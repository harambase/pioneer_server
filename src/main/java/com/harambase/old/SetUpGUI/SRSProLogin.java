...
import TecherGUI.SRSTeacherGUI;


@SuppressWarnings("serial")
public class SRSProLogin extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			SRSProLogin frame = new SRSProLogin();
	    			...
	    			try {
						...
						while(sc.hasNext()){
							...
							if(password.equals(line.split("\t")[1])){
								professor = SRSFunctions.makeAProfessor(id);
								login = true;
