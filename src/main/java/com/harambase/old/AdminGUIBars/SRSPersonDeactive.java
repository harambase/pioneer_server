...
public class SRSPersonDeactive extends JFrame implements ActionListener{
	...
	public SRSPersonDeactive() {
		...
		JLabel errorInfo = new JLabel("This Student/Teacher has been deactivated!");
