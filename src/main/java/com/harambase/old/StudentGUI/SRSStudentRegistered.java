...
public class SRSStudentRegistered extends JFrame implements ActionListener{
	...
	public SRSStudentRegistered() {
		...
		JLabel errorInfo = new JLabel("You cannot register into the course twice!");
