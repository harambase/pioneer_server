...
public class SRSInfoPassed extends JFrame implements ActionListener{
	...
	public SRSInfoPassed() {
		...
		JLabel errorInfo = new JLabel("This Student/Teacher/Semester has been registered!");
