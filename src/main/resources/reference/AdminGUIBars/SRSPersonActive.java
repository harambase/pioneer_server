...
public class SRSPersonActive extends JFrame implements ActionListener{
	...
	public SRSPersonActive() {
		...
		JLabel errorInfo = new JLabel("This Student/Teacher is Activated!");
